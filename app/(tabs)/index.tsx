            ...
            <ScrollView className='flex-1' contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
                <View className='px-6 pb-4 pt-6'>
                    ...
                    <View className='bg-surface flex-row items-center px-5 py-4 rounded-2xl'>
                        ...
                        <TextInput className='flex-1 ml-3 text-base text-text-primary' placeholder='Search for products...' placeholderTextColor='#666' value={searchQuery} onChangeText={setSearchQuery} />
                    </View>
                </View>
